...
python neologism/scripts/train_neologism_ct.py --concept long

# python neologism/scripts/eval_neologism_ct.py --concept short --concept_tokenizer_path neologism/checkpoints/tokenizer --concept_model_path neologism/checkpoints_short_ct/checkpoint-132
