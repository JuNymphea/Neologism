...
class NeologismDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        prompt_text_w_chat_template = f"<s><start_of_turn>user\n{prompt_text}\n<end_of_turn>\n<start_of_turn>model\n"

        prompt_enc = self.tokenizer(
            prompt_text_w_chat_template,
...
def train(model_name, new_token, concept, output_dir, batch_size, gradient_accumulation_steps, num_epochs, lr, beta, seed):
...
def main():
    ...
    train(args.model_name, args.new_token, args.concept, args.output_dir, args.batch_size, args.gradient_accumulation_steps, args.num_epochs, args.lr, args.beta, args.seed)
